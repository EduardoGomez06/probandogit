                        ...
                        <div class="col-xl-9 col-lg-10 mx-auto">
                            <div class="bg-faded rounded p-5">
                                <h2 class="section-heading mb-4">
                                    <span class="section-heading-upper">Best Brand - Smart bissnes</span>
                                    <span class="section-heading-lower">Sobre nosotros</span>
                                </h2>
                                <p>Best Brand es fundada en el año 2022 por Eduardo Gomez. estando en un pueblo de españa en el cual poco se sabia de el pocisionamiento de marca en la web, le surge la idea de comenzar una empresa para hacer que otras marcas y empresas se den a conocer en la web y asi llegar a mas clientes...</p>
                                <p class="mb-0">
                                    
                                    <em>Bienvenido/a!</em>
                                    Si lo que quieres es que todos te conoscan, vendas lo que vendas, este es tu lugar.
                                </p>
                            </div>
                        </div>
                    </div>
